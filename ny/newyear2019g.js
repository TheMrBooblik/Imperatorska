...
{
    (function(h){$('body > .wrap').css('margin-top', h ? '0px' : '80px');localStorage.setItem('nnmnylights', h?'hide':'show')})(parseInt($('body > .wrap').css('margin-top')));$('.b-page_newyear').toggle();return false;
}
...
$(function() {
    ...
    if (localStorage.getItem('nnmnylights') == 'hide') return;
